/**
 * Explicit route for /api/auth/sign-up/email so OPTIONS preflight is handled.
 * Next.js catch-all [...all] does not receive OPTIONS for this path; this route does.
 * Supports standard email+password sign-up (Better-Auth emailAndPassword).
 */
